...
public class DistributedLockManager implements TwoPhaseVotingListener,
    ...
    public synchronized boolean prepare(Object decree) throws VoteException {
        ...
        if (decree instanceof AcquireLockDecree) {
            ...
            if(log.isDebugEnabled())
                log.debug("Preparing to acquire decree " +
                          acquireDecree.lockId);
            ...
            if(log.isDebugEnabled())
                log.debug("Preparing to release decree " +
                          releaseDecree.lockId);
            ...
            if(log.isDebugEnabled())
                log.debug("Preparing to newResource decree " +
            ...
            if(log.isDebugEnabled())
                log.debug("Preparing to deleteResource decree " +
                          resourceDecree.lockId);
    ...
    public synchronized boolean commit(Object decree) throws VoteException {
        ...
        if (decree instanceof AcquireLockDecree) {
            ...
            if(log.isDebugEnabled())
                log.debug("Committing decree acquisition " +
            ...
            if(log.isDebugEnabled())
                log.debug("Committing decree release " +
                          ((LockDecree)decree).lockId);
            ...
            if(log.isDebugEnabled())
                log.debug("Committing decree newResource " +
                          ((LockDecree)decree).lockId);
            ...
            if(log.isDebugEnabled())
                log.debug("Committing decree deleteResource " +
                          ((LockDecree)decree).lockId);
    ...
    public synchronized void abort(Object decree) throws VoteException {
        ...
        if (decree instanceof AcquireLockDecree) {
            ...
            if(log.isDebugEnabled())
                log.debug("Aborting decree acquisition " +
                          ((LockDecree)decree).lockId);
            ...
            if(log.isDebugEnabled())
                log.debug("Aborting decree release " +
                          ((LockDecree)decree).lockId);
            ...
            if(log.isDebugEnabled())
                log.debug("Aborting decree newResource " +
                          ((LockDecree)decree).lockId);
            ...
            if(log.isDebugEnabled())
                log.debug("Aborting decree deleteResource " +
                          ((LockDecree)decree).lockId);
